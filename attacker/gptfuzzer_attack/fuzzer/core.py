...
if TYPE_CHECKING:
    from attacker.gptfuzzer_attack.fuzzer.mutator import Mutator, MutatePolicy
    from attacker.gptfuzzer_attack.fuzzer.selection import SelectPolicy

from attacker.gptfuzzer_attack.utils.template import synthesis_message
from attacker.gptfuzzer_attack.utils.predict import Predictor
